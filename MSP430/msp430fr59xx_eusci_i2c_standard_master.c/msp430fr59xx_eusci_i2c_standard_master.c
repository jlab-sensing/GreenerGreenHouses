...
void initI2C()
{
    ...
    UCB0I2CSA = HDC2021_ADDRESS;                   // Slave Address
...
int main(void) {
    ...
    initI2C();
     ...
     // I2C_Master_WriteReg(HDC2021_ADDRESS, CMD_TYPE_0_MASTER, MasterType0, TYPE_0_LENGTH);


    I2C_Master_ReadReg(HDC2021_ADDRESS, 0x00, TYPE_0_LENGTH);
    CopyArray(ReceiveBuffer, TempBitsLo, TYPE_0_LENGTH);

    I2C_Master_ReadReg(HDC2021_ADDRESS,0x01,TYPE_0_LENGTH);
    CopyArray(ReceiveBuffer, TempBitsHi, TYPE_0_LENGTH);
